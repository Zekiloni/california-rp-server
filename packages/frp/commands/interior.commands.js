        ...
        },
        {
            ...
            call: (player, args) => {
                if (player.inside != null) {
                    ...
                    switch (type) {
                        case 'house':
                            let house = mp.houses[player.inside.id], interior = new mp.Vector3(house.interior.x, house.interior.y, house.interior.z), entrance = new mp.Vector3(house.entrance.x, house.entrance.y, house.entrance.z);

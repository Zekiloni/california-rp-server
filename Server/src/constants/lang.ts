...
export const Lang = {
   ...
   BANK_ACCOUNT_NOT_FOUND: 'Bankovni račun nije pronadjen.',
   NOT_NEAR_ANY_JOB: 'Niste u blizini niti jednog posla.',
   TRANSACTION_SUCCESS_COMPLETED: 'Transakcija uspešna.',
   BANK_ACCOUNT_NOT_ACTIVE: 'Bankovni račun nije aktivan.',
   U_ALREADY_WORKING: 'Već radite.',
   NOT_ENOUGHT_BALANCE: 'Nemate dovoljno sredstava.',
   ...
   thisVehicleNotPartOfFaction: 'Ovo vozilo nije deo fakcije u kojoj se nalazite.',
   ...
   uGovRepairVehicle: 'Popravili ste vozilo o trošku fakcije.',
   personSays: ' kaže: ', 

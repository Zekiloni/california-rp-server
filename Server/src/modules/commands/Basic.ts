...
//       if (Character.Hours < 2) return Player.Notification(Messages.YOU_NEED_MINIMUM_2_HOURS_OF_PLAYING, notifications.type.ERROR, 5);
...
//             if (Amount > Character.Money) return Player.Notification(Messages.NOT_ENOUGH_MONEY, notifications.type.ERROR, 5); // PORUKA: Nemate dovoljno novca
//             if (Amount < 1) return Player.Notification(Messages.MINIMUM_PAY_AMOUNT, notifications.type.ERROR, 5);; // PORUKA: Ne mozes dati minus
...
//          } else {
//             Player.Notification(Messages.PLAYER_NOT_NEAR, notifications.type.ERROR, 5);
//          }
//       }
//    }
// };

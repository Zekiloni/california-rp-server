    ...
    'server:job.food.order:accept': async (player, index) => {
        ...
        if (Order && Order.Status == Status.Ordered) {
            ...
            if (player.getVariable('Job_Vehicle') == null) {
                ...
                let Vehicle = frp.Vehicles.CreateTemporary(Configuration.Vehicle.Model, AvailablePosition, Configuration.Vehicle.Rotation, Configuration.Vehicle.Color, 'FO0' + frp.Main.GenerateNumber(3));

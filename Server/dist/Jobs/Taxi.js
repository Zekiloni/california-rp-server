...
//       this.Taximeter = null;
//       this.Customers = [];
//       Taxi.Drivers[player.CHARACTER_ID] = this;
//    }
...
//          Player.Instructions('Vaše vozilo sa oznakom '+ (await Vehicle).numberPlate + ' se nalazi na parkingu iza.', 5);
...
//       if (!Player.getVariable('Job_Duty')) return Player.Notification(Messages.JOB_NOT_STARTED, Globals.Notification.Error, 5);
//       const Shift = Taxi.Drivers[Player.CHARACTER_ID];
//       if (Shift) { 

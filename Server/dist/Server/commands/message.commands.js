        ...
        },
        {
            ...
            call: (Player, args) => {
                ...
                if (Target) {
                    ...
                    if (!Message.trim())
                        return;
                    if (Player.dist(Target.position) > frp.Globals.distances.whisper)
                        return Player.Notification(frp.Globals.messages.PLAYER_NOT_NEAR, frp.Globals.Notification.Error, 5);

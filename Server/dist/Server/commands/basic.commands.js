        ...
        },
        {
            ...
            call: async (player, args) => {
                ...
                if (args[0]) {
                    ...
                    if (Target)
                        Target.call('client:player.documents:show', ['identity', Character]);
                }
                else {
        ...
        },
        {
            ...
            call: async (player, args) => {
                ...
                if (args[0]) {
                    let Target = mp.players.find(args[0]);
                    if (Target)
                        Target.call('client:player.documents:show', ['licenses', Character]);
                }
                else {
        ...
        },
        {
            ...
            call: async (player, args) => {
                ...
                if (Character.Hours < 2)
                    return player.Notification(frp.Globals.messages.YOU_NEED_MINIMUM_2_HOURS_OF_PLAYING, frp.Globals.Notification.Error, 5);
                ...
                if (Target) {
                    if (player.IsNear(Target)) {
                        ...
                        if (Amount < 1)
                            return; // PORUKA: Ne mozes dati minus

"use strict";
let { ItemRegistry, ItemEntities, ItemType } = require('../classes/Items.Registry');
module.exports = {
    commands: [
        {
            name: 'itemlist',
        ...
        },
        {
            ...
            call: (player, args) => {
                ...
                if (Target && ItemRegistry[Item])
                    frp.Items.New(Item, quantity, ItemEntities.Player, Target.character);
            }
        },
        {
            name: 'clearinventory',

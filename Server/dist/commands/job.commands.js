    ...
    commands: [
        {
            ...
            call: async (player, args) => {
                ...
                if (Character.Job != frp.Globals.Jobs.Unemployed)
                    return player.Notification(frp.Globals.messages.ALREADY_EMPLOYED, frp.Globals.Notification.Error, 5);
        ...
        },
        {
            ...
            call: async (Player, args) => {
                ...
                if (Characcter.Job == frp.Globals.Jobs.Unemployed)
            ...
            call: (Player, args) => {
                ...
                switch (action) {
                    case frp.Globals.Words.Stop:
                        frp.Sanitation.Stop(Player);
                        break;
                    case frp.Globals.Words.Start:
                        frp.Sanitation.Start(Player);
                        break;
                }
            }
        },
        ...
        },
        {
            ...
            call: (Player, args) => {
                ...
                switch (action) {
                    ...
                    case frp.Globals.Words.Start: {
                        if (Player.dist(frp.Jobs.Job[frp.Globals.Jobs.Taxi].position) > 3)
                            return Player.Notification(frp.Globals.messages.NOT_ON_POSITION, frp.Globals.Notification.Error, 5);
        ...
        },
        {
            ...
            call: (Player) => {
                if (frp.Food.Orders.length < 1)
                    return Player.Notification(frp.Globals.messages.THERE_ARE_NO_ORDERS_RIGHT_NOW, frp.Globals.Notification.Error, 5);

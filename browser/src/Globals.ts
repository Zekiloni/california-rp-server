...
export const Messages = {
   ...
   WANT_TO_BE_USER: 'Želite postati korisnik ?',
   ...
   BUSINESS_PRODUCTS: 'Produkti biznisa',
   BUSINESS_WORKERS: 'Zaposleni',
   BUSINESS_NOT_FOR_SALE: 'Ovaj biznis nije na prodaju.',
   PRODUCT_NAME: 'Ime proizvoda',
   PRODUCT_QUANTITY: 'Dostupna količina',
   PRODUCT_PRICE: 'Cena proizvoda',
   ARTICLE: 'Artikal',
   QUANTITY: 'Količina',
   PRICE: 'Cena',
   ALREADY_USER: 'Postojeći korisnik',
   CASH_CREDIT: 'Keš kredit',
   ADD_WORKER: 'Dodaj radnika',
   CREDIT_CARD: 'Credit Card',
   PERSON_NAME: 'Ime osobe',
   SALARY: 'Plata',
   EXP: 'exp',
   PIN: 'pin',
   CRD: 'crt',
   ...
   HIRED_BY: 'Zaposlio',
   LOS_SANOTS: 'Los Santos',
   BANK_OF: 'Bank of',
   ITEM_WEIGHT: 'težina predmeta ',
   REGISTERING_BANK_ACCOUNT: 'Pravljenje bankovnog računa',
   DO_U_AGREE: 'Da li ste slažete sa uslovima i pravilima korišćenja ?',
   FIRST_NAME: 'Ime',
   ...
   FACTION_RANK_EDIT: 'Podešavanje ranka',
   PRESS_ON_RANK_TO_EDIT: 'Pritisnite na rank kako bi ga uredili, pritisnite opet kako bi poništili uredjivanje',
   FACTION_RANK_SALARY: 'Procenat plate',
   ...
   PHONE_APP_CONTACTS: 'Kontakti',
   TYPE_YOUR_MESSAGE: 'Poruka...',
   PHONE_APP_MESSAGES: 'Poruke',
   PHONE_MESSAGES_SEARCH: 'Pretraga konverzacija...',
   PHONE_CONTACTS_SEARCH: 'Pretraga kontakata...',
   PHONE_NUMBER: 'Broj telefona',
   PHONE_BACK_TO_CONTACTS: 'Nazad nan listu kontakata',
   PONE_BACK_TO_MESSAGES: 'Nazad na konverzacije',
   DEVICE_VERSION: 'Verzija softvera',
   PHONE_DELETE_CONTACT: 'Izbriši kontakt',
   PHONE_SHARE_CONTACT: 'Podeli kontakt',
   INCOMING_CALL: 'Nadolazeći poziv',
   PHONE_CONTACT_CREATED: 'Datum kreiranja',
   CALLING: 'Pozivanje',
   ...
   BANK_HOME: 'Informacije',
   BALANCE: 'Balans',
   BANK_ACCOUNT_INFO: 'Osnovne informacije',
   ACCOUNT_ACTIVE: 'Račun aktivan',
   DATE_OF_REGISTRATION: 'Datum kreiranja',
   ...
   GET_PAYMENT: 'Isplata',
   BANK_LOAN_CHECK: [
      'Iznos kredita do 3.000.000 $.', 'Bez troškova održavanja kredita.', ' Sa uključenim osiguranjem.', 
   ],
   NEED_LOAN: 'Potreban vam je kredit ? Na pravom ste mestu !',
   WITHDRAW_THE_MONEY: 'Podigni Novac',
   DEPOSIT_THE_MONEY: 'Ostavi Novac',
   BANK_ACCOUNT_NOW: 'Postanite korisnik već danas. Bez mesečnih održavanja.',

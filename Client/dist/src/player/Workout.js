"use strict";
const Player = mp.players.local, PushUps = "PROP_HUMAN_MUSCLE_CHIN_UPS_PRISON", MuscleFlex = "WORLD_HUMAN_MUSCLE_FLEX", FreeWeight = "WORLD_HUMAN_MUSCLE_FREE_WEIGHTS";
...
let isTraining = false, workout = null, lpWorkout = null;
mp.keys.bind(0x59, false, function () {
    if (Player.logged && Player.spawned) {
        if (Player.vehicle || Player.cuffed || Player.isTypingInTextChat || lpWorkout == null)
            return;
